...
BLOCK_THRESH = 20.0            # per-block mean |diff| after median normalization
...
def main():
    ...
    summary = "%d/%d cams visually active <24h" % (active, len(CAMS))
    if quiet:
